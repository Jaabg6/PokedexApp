        ...
        <div class="col-span-5 md:col-span-3    self-center  rounded-lg bg-gray-900 mx-5 mt-32">
            ...
            <div class="mx-8">
              <div class="flex items-center justify-center ">
                ...
                <h1 class=" mt-5 text-3xl sm:text-4xl font-extrabold text-slate-900 tracking-tight dark:text-slate-200 text-center "> <span class="hidden sm:inline">Random</span> Pokedex</h1>
                  <img class=" mt-auto h-8 sm:h-12 w-auto ml-2" src="../static/pokeball.png" alt="Logo">

              </div>
              <button @click="getRandomPokemon()" class="mt-5 py-3 pl-5 rounded bg-gray-600 hover:bg-gray-800 w-full text-slate-200">
                <span class="text-white text-xl ">Search Random Pokemon</span>
              </button>
...
export default {
 ...
 mounted(){
    ...
    this.$store.dispatch('getRandomPokemon');
